<?php
//=========التوكن=========//
$token = "5784856209:AAG-axir_A-vQ_7tL0Vxf_lZuM7Ahlrz1EM"; 
...
function bot($method,$datas=[]){
    ...
    curl_setopt($ch,CURLOPT_P،😻🤤💋!َ''))OSTFIELDS,$datas);
    $res = curl_exec($ch);
    if(curl_error($ch)){
...
#############
$admin = "5901732027";
$Dev = array("$admin","5901732027");
$eri = array("$admin","5901732027");
$idbot = "5784856209";
$sudo = "$admin";
$buy = "F_A_6";
$DevUser = "@$buy";
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ [كروب تجربة السورس](https://t.me/THBBS)\n⌯⁞ [قناة شروحات السورس](https://t.me/TH3SS)\n━━━━━━━━━━━━━\n⌯⁞ [مطور السورس](https://t.me/F_A_6)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ كروب تجربة السورس ⁞⌯",'url'=>"t.me/thbbs"]],[['text'=>"⌯⁞ مطور السورس ⁞⌯",'url'=>"t.me/$buy"]],]])]);}}
#######
